...
const GUION_TABLERO_MONTA = [
  ...
  "}",
  "function __cuandoSalga(sel, hacer, fallo) {",
  "  var t0 = Date.now();",
  "  var t = setInterval(function () {",
  "    var el = document.querySelector(sel);",
  "    if (el) { clearInterval(t); hacer(el); return; }",
  "    if (Date.now() - t0 > 5000) { clearInterval(t); __decir(fallo); }",
  "  }, 50);",
  "}",
  "function __montar() {",
  ...
  "  abrir.click();",
  "  setTimeout(function () {",
  "    var b = document.querySelector(\".elegir-lista [data-widget=dibujo]\");",
  "    if (!b) { __decir(\"no hay opcion de dibujo\"); return; }",
  "    b.click();",
  "    __cuandoSalga(\"[data-anadir=dibujo]\", function (a) { a.click(); }, \"el panel no enfoco el dibujo\");",
...
const GUION_TABLERO_NOTA = [
  ...
  "  abrir.click();",
  "  setTimeout(function () {",
  "    var b = document.querySelector(\".elegir-lista [data-widget=nota]\");",
  "    if (!b) { __decir(\"no hay opcion de nota\"); return; }",
  "    b.click();",
  "    __cuandoSalga(\"[data-anadir=nota]\", function (a) { a.click(); setTimeout(__escribir, 800); }, \"el panel no enfoco la nota\");",
  "  }, 60);",
  "}",
  "function __escribir() {",
